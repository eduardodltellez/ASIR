...
<script type="text/javascript" src="js/borrar_discos.js"></script>
...
<br/>
    ...
    <ul id="admin_discos">
        ...
        <li><a href='borrar_discos.php' style="background-color: #00bd42"> Borrar discos</a></li>
...
/// Si hemos seleccionado discos para borrar
if(isset($_POST['borrar'])) {

  $borrar=$_POST['borrar']; // array con todos los números de referencia de los discos seleccionados

  $i=0;

  foreach($borrar as $valor) {
    $sql = "DELETE FROM discos where num_referencia='$valor'";
...
if ($i == 1) {
    echo "<p style='color:green'>Se ha eliminado $i disco.</p>";
} else {
   echo "<p style='color:green'>Se han eliminado $i discos.</p>";
}
...
<button onclick="seleccionar_todo()" style="color: red;">Marcar/Desmarcar todos</button><br/><br/>
...
/// mostrar la tabla con un checkbox para eliminar los discos
echo "<form name='f1'method='post' action='borrar_discos.php'>
...
<th><input type='submit' value='Eliminar' name='eliminar' style='width:85px; height:35px; font-weight: bold; color: red;'/></th> </tr>";
...
while($fila = mysqli_fetch_assoc($resultado)) {
	...
	echo "<td> <input type='checkbox' name='borrar[]' value='$referencia'></td>";
